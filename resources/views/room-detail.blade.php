					...
					<div class="row white">
							...
							<div class="row">
								<form class="col s12">
									<div style="padding-top:10px">
										<pre><h6 class="header-color-text">Room Number	: </h6></pre>
										<pre><h6 class="header-color-text">Room Type		: </h6></pre>
									</div>
									<div class="divider"></div>
									<div class="row">
										<div class="col l6">
									...
									<pre class="col s12"><p>Price	: </p></pre>
								</form>
							</div>
						</div>
						<!--End Room Detail-->
						...
						<div class="col s12 m12 l6">
							...
							<div class="row" style="padding-top:20px">
								<div class="col s12">
									<h6 class="header-color-text">Room Detail View</h6>
								</div>
							</div>
							<div class="row">
								<div class="col s12">
									<div class="divider"></div>
									<p><a class="header-color-text" href="roomView" target="_blank">Room View</a></p>
									<p><a class="header-color-text" href="toiletView" target="_blank">Toilet View</a></p>
									<div class="divider"></div>
								</div>
							</div>
							<div class="row">
								<div class="col s12">
									<a class="btn waves-effect waves-light side-nav-background" href="roomReservation">Back</a>
									<a class="btn waves-effect waves-light side-nav-background" href="room-reservation-detail">Pesan</a>
								</div>
							</div>
						</div>
