...
<html>
<head>
	<title>Check-Out | Front Office</title>
	<!--import link icon-->
			...
			<div>
				<ul id="nav-mobile" class="side-nav fixed side-nav-background">
					...
					<li class="user-profile hide-on-med-and-down" style="margin-bottom:20px">
      				...
      				<li><a class="white-text" href="room-reservation.php"><i class="material-icons white-text">hotel</i> Room Reservation</a></li>
		...
		<section id="content">
			<div class="container-main margin-on-med-and-down">
				...
				<div id="table-content">
					...
					<div class="col s12 m12 l12 white padding-on-med-and-down border-all" style="margin-left:70px;margin-right:70px;margin-bottom: 70px;">
						<div class="row">
							<form class="col s12" action="checkOutDetail" method="POST">
							<?php echo csrf_field(); ?>
								<div class="row" style="padding-bottom:40px">
									<h5 class="center header-color-text" style="padding-top:10px">Check Out</h5>
								</div>
								<div class="row padding-on-med-and-down" style="margin-right:160px;margin-left:160px;">
									<div class="input-field col s12">
										<input id="roomNumber" type="text" class="validate" name="room">
										<label for="roomNumber">Input Room Number</label>
									</div>
								</div>
								<div class="row col s12 center" style="padding-bottom:40px">
